						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold" id="notification_count">Notifications</h6>
											<a href="{{route('markAsReadAll')}}" class="badge badge-pill badge-warning mr-auto my-auto float-left">Mark All Read</a>
										</div>
									...
									<div class="main-notification-list Notification-scroll" id="unreadnotification">
										...
										<a class="d-flex p-3 border-bottom" href="{{route('InvoicesDeteils',$notification->data['id'])}}">
											...
											<div class="mr-3">
												...
												<h5 class="notification-label mb-1">{{$notification->data['user']}}</h5>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/18.png')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/18.png')}}" class=""></div>
